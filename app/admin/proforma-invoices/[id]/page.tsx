...
export default function ProformaInvoiceDetailPage() {
  ...
  return (
    <AdminLayout>
      <div className="p-6">
        <h1 className="text-2xl font-bold mb-6">Proforma Invoice: {document.documentNumber}</h1>
        <UniversalInvoiceTemplate data={document} basePath="/admin/proforma-invoices" />
        <Toaster />
      </div>
    </AdminLayout>
  )

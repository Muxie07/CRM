...
export function ClientForm({ initialData, onSubmit, isSubmitting }: ClientFormProps) {
  ...
  const handleRadioChange = (value: string) => {
    setFormData((prev) => ({ ...prev, category: value as "Tamil Nadu" | "Other States" }))
  }
          ...
          <div className="space-y-2">
            ...
            <RadioGroup value={formData.category} onValueChange={handleRadioChange} className="flex space-x-4">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Tamil Nadu" id="category-tn" />
                <Label htmlFor="category-tn">Tamil Nadu</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Other States" id="category-other" />
                <Label htmlFor="category-other">Other States</Label>
              </div>
            </RadioGroup>
          </div>
        </CardContent>

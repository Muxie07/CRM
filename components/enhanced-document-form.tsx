...
import { EnhancedDocumentTemplate, type DocumentData, type DocumentType } from "@/components/enhanced-document-template"
...
export function EnhancedDocumentForm({
  ...
  const handleClientChange = (clientId: string) => {
    ...
    if (client) {
      setDocumentData((prev) => ({
        ...prev,
        consigneeName: client.name || client.companyName,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: `${documentData.documentType} ${documentData.documentNumber} has been ${isEditing ? "updated" : "saved"} successfully.`,
      })
    ...
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as "edit" | "preview")}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={documentData.status} onValueChange={(value) => handleFieldChange("status", value)}>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>
                    {documentType === "Purchase Order" ? "Consignee Information" : "Client Information"}
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="client">
                      {documentType === "Purchase Order" ? "Select Consignee" : "Select Client"}
                    </Label>
                    <Select onValueChange={handleClientChange}>
                      <SelectTrigger id="client">
                        <SelectValue
                          placeholder={documentType === "Purchase Order" ? "Select consignee" : "Select client"}
                        />
                      </SelectTrigger>
                      <SelectContent>
                        {clients.map((client) => (
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="consigneeName">
                      {documentType === "Purchase Order" ? "Consignee Name" : "Client Name"}
                    </Label>
                    <Input
                      id="consigneeName"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="consigneeAddress">
                      {documentType === "Purchase Order" ? "Consignee Address" : "Client Address"}
                    </Label>
                    <Textarea
                      id="consigneeAddress"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="consigneeContact">
                      {documentType === "Purchase Order" ? "Consignee Contact" : "Client Contact"}
                    </Label>
                    <Input
                      id="consigneeContact"
        ...
        <TabsContent value="preview">
          <EnhancedDocumentTemplate data={documentData} basePath={basePath} />
        </TabsContent>
      </Tabs>
    </div>
  )

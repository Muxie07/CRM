...
import { Printer, FileSpreadsheet, FileIcon as FilePdf, Send } from "lucide-react"
...
interface UniversalDocumentTemplateProps {
  data: DocumentData
  isEditable?: boolean
  onSave?: (data: DocumentData) => void
}

export function UniversalDocumentTemplate({ data, isEditable = false, onSave }: UniversalDocumentTemplateProps) {
